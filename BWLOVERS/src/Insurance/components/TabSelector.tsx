...
export default function TabSelector<T extends string>({
  ...
  return (
    <div className="inline-grid w-full grid-cols-3 bg-white px-6">
      {tabs.map((item) => {
        ...
        return (
          <button
            ...
            className={`row-start-1 row-end-2 inline-flex items-center justify-center gap-2.5 justify-self-center px-1 py-2.75 ${
              isActive
